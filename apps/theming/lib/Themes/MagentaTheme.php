...
class MagentaTheme extends DefaultTheme implements ITheme {
	...
	public function getTitle(): string {
		return $this->l->t('MagentaCLOUD theme');
	}

	public function getEnableLabel(): string {
		return $this->l->t('Enable the MagentaCLOUD theme');
	}

	public function getDescription(): string {
		return $this->l->t('MagentaCLOUD is a Deutsche Telekom service for providing storage space on the Internet.');
	}
	...
	public function getCSSVariables(): array {
		$this->primaryColor = '#e20074';
		$this->defaultPrimaryColor = '#e20074';
